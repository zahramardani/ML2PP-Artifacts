...
The thesis uses a chronological 80/20 split: 3,360 fitting observations and 840 held-out observations, yielding 838 complete three-step test origins. Holt-Winters uses a 60-observation seasonal cycle. The subset spans only about 70 hours, so it does not support a reliable 1,440-minute daily-seasonality benchmark. The checked CSV and its PDF data card are deposited in this directory.
